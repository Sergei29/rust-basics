...
pub fn c_simple_types() {
    ...
    //
    let coords_arr = get_array_from_tuple(coords);
...
fn get_array_from_tuple(tuple_of_2: (f32, f32)) -> [f32; 2] {
    [tuple_of_2.0, tuple_of_2.1]
}

fn get_number_13(arr_of_nums: [i32; 7]) -> i32 {
    let mut maybe_13 = 0;
